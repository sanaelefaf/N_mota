        ...
        <div class="containerSingle">
            <div class="detailsPhoto">
                ...
                <div class="infosPhoto">
                    ...
                    <p><?php echo 'ANNEE: ' . esc_html($article_date) . '<br>'; ?></p>
        ...
        <div class="contactBtn">
         ...
         <div class="navigationArrows">
             ...
             <div class="containerImgArrows">
                 ...
                 $thumbnail_html = '';
                 if (!empty($nextPost))//Si l'article suivant existe 
                 {
                    $thumbnail_html = get_the_post_thumbnail($nextPost->ID, 'thumbnail');//récupère la miniature de l'article suivant 
                 } elseif (!empty($previousPost)) {
                    $thumbnail_html = get_the_post_thumbnail($previousPost->ID, 'thumbnail');// " precedent 
                 }
                 if (!empty($thumbnail_html)) ///vérifie si une miniature a été récupérée avec succès.
         
                 //affiche la miniature du lien p en créant une div
                 {
             ...
             <div class="arrowsContainer">
                 <?php if (!empty($previousPost)) ://Si une miniature a été récupérée, elle est affichée à l'intérieur du conteneur containerImgArrows. ?>
                    ...
                    <a href="<?php echo esc_url(get_permalink($previousPost->ID)); ?>"
                        ...
                        //L'URL du lien est générée à partir de l'URL de l'article précédent, 
                        // attribut "data-thumbnail" qui stocke l'URL de la miniature de l'article précédent.
                        ?>">
                 ...
                 <?php if (!empty($nextPost)) : //Cette ligne vérifie si un article précédent existe.?>
                    ...
                    <a href="<?php echo esc_url(get_permalink($nextPost->ID)); ?>" class="arrowLink arrowLinkNext"
                        ...
                        //L'URL du lien est générée à partir de l'URL de l'article précédent, 
                        //et il y a un attribut "data-thumbnail" qui stocke l'URL de la miniature de l'article précédent.
                        ?>">
